 ...
 * @property {string} pemKey   chave privada PEM do escritório (uso: assinatura XML eSocial)
 * @property {string} pemCert  certificado PEM do titular (uso: assinatura XML eSocial)
